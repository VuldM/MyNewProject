Public Class frm6
    Public Q06() As String = IO.File.ReadAllLines(Application.StartupPath & "\T6.pz", System.Text.Encoding.Default)
    ...
    Private Sub Schit()
        If Q06.Length < N(7) Then Return
        Dim D1() As Integer = {Len(Q06(N(0))) - 1, Len(Q06(N(1))) - 1, Len(Q06(N(2))) - 1,
                               Len(Q06(N(3))) - 1, Len(Q06(N(4))) - 1, Len(Q06(N(5))) - 1, Len(Q06(N(6))) - 1}

        For i As Integer = 0 To D1(0)
            lblText.Text &= Q06(N(0))(i)
        Next i
        For i As Integer = 0 To D1(1)
            lbl10.Text &= Q06(N(1))(i)
        Next i
        For i As Integer = 0 To D1(2)
            lbl11.Text &= Q06(N(2))(i)
        Next i
        For i As Integer = 0 To D1(3)
            lbl12.Text &= Q06(N(3))(i)
        Next i
        For i As Integer = 0 To D1(4)
            lbl13.Text &= Q06(N(4))(i)
        Next i
        For i As Integer = 0 To D1(5)
            lbl14.Text &= Q06(N(5))(i)
        Next i
    ...
    Private Sub Rt()
        If Q06.Length < N(7) Then cmdID.Enabled = False : Return
        lbl10.Visible = True
        lbl11.Visible = True
        lbl12.Visible = True
        lbl13.Visible = True
        ...
        If Val(Q06(N(7))(0)) = 1 Then lbl11.Visible = False : lbl12.Visible = False : lbl13.Visible = False : lbl14.Visible = False
        If Val(Q06(N(7))(0)) = 2 Then lbl12.Visible = False : lbl13.Visible = False : lbl14.Visible = False
        If Val(Q06(N(7))(0)) = 3 Then lbl13.Visible = False : lbl14.Visible = False
        If Val(Q06(N(7))(0)) = 4 Then lbl14.Visible = False
    ...
    Private Sub frm1_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        Me.Text = "тема:Инструкция по применению и испытанию средств защиты, используемых в электроустановках"
    ...
    Private Sub Loc()
        ...
        If Len(Q06(N(0))) < 605 Then A(0) = 250
        If Len(Q06(N(0))) < 480 Then A(0) = 200
        If Len(Q06(N(0))) < 360 Then A(0) = 150
        If Len(Q06(N(0))) < 240 Then A(0) = 100
        If Len(Q06(N(0))) < 120 Then A(0) = 90

        If Len(Q06(N(1))) < 605 Then A(1) = A(0) + 140
        If Len(Q06(N(1))) < 480 Then A(1) = A(0) + 115
        If Len(Q06(N(1))) < 360 Then A(1) = A(0) + 90
        If Len(Q06(N(1))) < 240 Then A(1) = A(0) + 65
        If Len(Q06(N(1))) < 125 Then A(1) = A(0) + 35

        If Len(Q06(N(2))) < 605 Then A(2) = A(1) + 140
        If Len(Q06(N(2))) < 480 Then A(2) = A(1) + 115
        If Len(Q06(N(2))) < 360 Then A(2) = A(1) + 90
        If Len(Q06(N(2))) < 240 Then A(2) = A(1) + 65
        If Len(Q06(N(2))) < 120 Then A(2) = A(1) + 35

        If Len(Q06(N(3))) < 605 Then A(3) = A(2) + 140
        If Len(Q06(N(3))) < 480 Then A(3) = A(2) + 115
        If Len(Q06(N(3))) < 360 Then A(3) = A(2) + 90
        If Len(Q06(N(3))) < 240 Then A(3) = A(2) + 65
        If Len(Q06(N(3))) < 120 Then A(3) = A(2) + 35

        If Len(Q06(N(4))) < 605 Then A(4) = A(3) + 140
        If Len(Q06(N(4))) < 480 Then A(4) = A(3) + 115
        If Len(Q06(N(4))) < 360 Then A(4) = A(3) + 90
        If Len(Q06(N(4))) < 240 Then A(4) = A(3) + 65
        If Len(Q06(N(4))) < 120 Then A(4) = A(3) + 35
    ...
    Private Sub cmdID_Click(sender As Object, e As EventArgs) Handles cmdID.Click
        ...
        If P = Val(Q06(N(7))(1)) Then 'если правильный ответ соответствует выбранному то:
            i += 1
            ...
            If Q06.Length <= N(7) Then  'Если количество строк в файле меньше или равно N(7) 
            ...
            End If
        Else
            If Val(Q06(N(7))(1)) = 1 Then lbl10.BackColor = Color.LightGreen
            If Val(Q06(N(7))(1)) = 2 Then lbl11.BackColor = Color.LightGreen
            If Val(Q06(N(7))(1)) = 3 Then lbl12.BackColor = Color.LightGreen
            If Val(Q06(N(7))(1)) = 4 Then lbl13.BackColor = Color.LightGreen
            If Val(Q06(N(7))(1)) = 5 Then lbl14.BackColor = Color.LightGreen
